...
class WindField:
    ...
    def simulate_wind_field(self, with_baseline = False, show = False, save = None, log_files = None): 
        ...
        ax[0].legend()
        ax[0].set_xlim([0,self.__final_time*self.__dt])
        ax[1].plot(T_sim,self.__ctl_theta)
        ...
        ax[1].legend()
        ax[1].set_xlim([0,self.__final_time*self.__dt])
        ax[2].plot(T_sim,self.__ctl_psi)
        ...
        ax[2].legend()
        ax[2].set_xlim([0,self.__final_time*self.__dt])
        ax[3].plot(T_sim,self.__ctl_a)
        ...
        ax[0].plot(T[:self.__final_time],target_p[0,:self.__final_time],'--',color='orange',label='Reference x Position')
        ...
        ax[0].plot(T[:self.__final_time],target_p[1,:self.__final_time],'--',color='orange',label='Reference y Position')
        ...
        ax[0].plot(T[:self.__final_time],target_p[2,:self.__final_time],'--',color='orange',label='Reference z Position')
        ...
        ax[0].plot(T[:self.__final_time],target_v[0,:self.__final_time],'--',color='orange',label='Reference x Velocity')
        ...
        ax[0].plot(T[:self.__final_time],target_v[1,:self.__final_time],'--',color='orange',label='Reference y Velocity')
        ...
        ax[0].plot(T[:self.__final_time],target_v[2,:self.__final_time],'--',color='orange',label='Reference z Velocity')
    ...
    def draw_wind_field(self,show=False,save=None):
        ...
        ax.set_xlim([0.0,self.__width])
        ax.set_ylim([0.0,self.__height])
        ax.plot(np.nan,np.nan,'-',linewidth=8,color='orange',alpha=0.5,label='Wind Speed')
