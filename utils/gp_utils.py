...
def train_ExactGP(train_data, train_labels, models, likelihoods, name, training_iter=10000):
    '''
...
def test_ExactGP(test_data, test_labels, models, likelihoods, name, T, save=False, show=True):
    '''
