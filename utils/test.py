...
def test_SVGP(gp_data,x_labels,y_labels,T,save_plots,options):
    ...
    if options['RBF-Periodic']:
        ...
        likelihood_x.load_state_dict(likelihood_x_dict)
        likelihood_y.load_state_dict(likelihood_y_dict)
        inducing_points = torch.load('data/SVGP/inducing_points-RBF-Periodic.pt')
    ...
    if options['Matern-32']:
        ...
        likelihood_x.load_state_dict(likelihood_x_dict)
        likelihood_y.load_state_dict(likelihood_y_dict)
        inducing_points = torch.load('data/SVGP/inducing_points-Matern-32.pt')
    ...
    if options['Matern-52']:
        ...
        likelihood_x.load_state_dict(likelihood_x_dict)
        likelihood_y.load_state_dict(likelihood_y_dict)
        inducing_points = torch.load('data/SVGP/inducing_points-Matern-52.pt')
    ...
    if options['SpectralMixture-3']:
        ...
        likelihood_x.load_state_dict(likelihood_x_dict)
        likelihood_y.load_state_dict(likelihood_y_dict)
        inducing_points = torch.load('data/SVGP/inducing_points-SpectralMixture-3.pt')
    ...
    if options['SpectralMixture-5']:
        ...
        inducing_points = torch.load('data/SVGP/inducing_points-SpectralMixture-5.pt')
    ...
    if options['SpectralMixture-10']:
        ...
        likelihood_x.load_state_dict(likelihood_x_dict)
        likelihood_y.load_state_dict(likelihood_y_dict)
        inducing_points = torch.load('data/SVGP/inducing_points-SpectralMixture-10.pt')
