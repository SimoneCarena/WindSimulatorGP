...
class ExactGPModelRBF(gpytorch.models.ExactGP):
    def __init__(self, train_data, train_labels, likelihood):
        super(ExactGPModelRBF, self).__init__(train_data, train_labels, likelihood)
        # Mean Function
...
class ExactGPModelRBFPeriodic(gpytorch.models.ExactGP):
    def __init__(self, train_data, train_labels, likelihood):
        super(ExactGPModelRBFPeriodic, self).__init__(train_data, train_labels, likelihood)
        # Mean Function
        self.mean_module = gpytorch.means.ConstantMean()
        # Covariance Function, i.e. kernel specification
...
class ExactGPModelMatern_32(gpytorch.models.ExactGP):
    def __init__(self, train_data, train_labels, likelihood):
        super(ExactGPModelMatern_32, self).__init__(train_data, train_labels, likelihood)
        # Mean Function
        self.mean_module = gpytorch.means.ConstantMean()
        # Covariance Function, i.e. kernel specification
...
class ExactGPModelMatern_52(gpytorch.models.ExactGP):
    def __init__(self, train_data, train_labels, likelihood):
        super(ExactGPModelMatern_52, self).__init__(train_data, train_labels, likelihood)
        # Mean Function
        self.mean_module = gpytorch.means.ConstantMean()
        # Covariance Function, i.e. kernel specification
...
class ExactGPModelSpectralMixture_3(gpytorch.models.ExactGP):
    def __init__(self, train_data, train_labels, likelihood):
        super(ExactGPModelSpectralMixture_3, self).__init__(train_data, train_labels, likelihood)
        # Mean Function
        self.mean_module = gpytorch.means.ConstantMean()
        # Covariance Function, i.e. kernel specification
